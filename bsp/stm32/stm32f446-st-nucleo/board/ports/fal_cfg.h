...
#define ONCHIP_FLASH_PART_TABLE \
    {FAL_PART_MAGIC_WROD, "bootloader_48k",  "onchip_flash_16k",  0 , (FLASH_SIZE_GRANULARITY_16K/4)*3 , 0}, \
    {FAL_PART_MAGIC_WROD, "mcu_param1_16k",  "onchip_flash_16k",  (FLASH_SIZE_GRANULARITY_16K/4)*3, FLASH_SIZE_GRANULARITY_16K/4, 0}, \
    {FAL_PART_MAGIC_WROD, "mcu_param2_64k",  "onchip_flash_64k",  0 , FLASH_SIZE_GRANULARITY_64K , 0}, \
