...
if  CROSS_TOOL == 'gcc':
    PLATFORM 	= 'gcc'
    EXEC_PATH 	= r'E:/Program Files (x86)/GNU Tools ARM Embedded/5.4 2016q2/bin'
...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' -g -Wall -DSTM32F756xx -DUSE_HAL_DRIVER -D__ASSEMBLY__  -eentry'
