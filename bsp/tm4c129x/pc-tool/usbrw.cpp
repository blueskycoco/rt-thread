...
int main(int argc, _TCHAR* argv[])
{
	...
	HANDLE hFile_out,hFile_in;
    int ret,i,write=0,read=0;
	...
	if(argv[3]!=NULL)
	{
		TcharToChar(argv[3],&file_out);
		hFile_out = CreateFile((const CHAR *)(LPCWSTR)(argv[3]),
		    GENERIC_WRITE,  
		    FILE_SHARE_WRITE,  
		    NULL,  
		    CREATE_ALWAYS,  
	...
	TcharToChar(argv[2],&file_in);
	 hFile_in = CreateFile((const CHAR *)(LPCWSTR)(argv[2]),  
        GENERIC_READ,  
        FILE_SHARE_READ,  
        NULL,  
        OPEN_EXISTING,  
	 ...
	 if(!write && !read)
	 {
		printf("./bulk 1 pc_to_usb_file_name usb_to_pc_file_name\n");
		return 0;
	 }
