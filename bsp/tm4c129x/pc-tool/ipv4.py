...
class MiniClient:
    ...
    def serverT6(self):
        tcpT6Server = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        print "Server Socket Created......."
        fout = open(self.file_out,'wb')
        print "Open file ",self.file_out, "done........"
        tcpT6Server.bind((self.h, self.p))
        print "TCP IPv4 Server Mode, Wating for connecting......."
    ...
    def tcpC6(self):
        ...
        print "TCP IPv4 Client Mode, connected to server,waiting from data ..."
        timeb=time.time()
    ...
    def udpC6(self):
        udpU6Client = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        fout = open(self.file_out,'wb')
        print "Open file ",self.file_out, "done........"
        udpU6Client.bind((self.h, self.p))
        print "UDP IPv4 Mode connected,waiting from data ..."
        while True:
